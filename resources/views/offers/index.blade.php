                    ...
                    <table id="myTable" class="table small-table-text text-center">
                        ...
                        <tbody>
                            ...
                            <tr style="white-space: nowrap; font-size: 14px;">
                                ...
                                <td>{{ $offer->price_before_discount ? $offer->price_before_discount .' ₪' : 'N/A' }}</td>
                                <td>{{ $offer->discount_percentage ? $offer->discount_percentage .'%'  : 'N/A' }}</td>
                                <td>{{ $offer->discount_amount ? $offer->discount_amount .' ₪' : 'N/A' }}</td>
                                <td>
