...
<body class="nav-fixed">
    ...
    <nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
        ...
        <ul class="navbar-nav align-items-center ml-auto ">
            ...
            <li class="nav-item dropdown no-caret " style="padding-top: 2px">
                <a class="nav-link dropdown-toggle" id="navbarDropdownDocs" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><small>Sittings <i class="fas fa-chevron-right dropdown-arrow"></i></small></a>
                <div class="dropdown-menu dropdown-menu-right animated--fade-in-up" aria-labelledby="navbarDropdownDocs">
                    ...
                    <a class="dropdown-item py-3" href="#" onclick="event.preventDefault();
                        ...
                        <div class="icon-stack bg-primary-soft text-primary mr-4"><i class="fas fa-sign-out-alt"></i></div>
                        <div>
                    ...
                    <div class="page-header-content pt-4">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-12 col-md-6 mt-4">
                                ...
                                <div class="page-header-subtitle text-white-75">This panel is shown only to those who have the special permission to add sellers</div>
                            </div>
                            <div class="col-12 col-md-6 mt-4 text-right">
                                @if (Route::currentRouteName() !== 'delegates.mainView')
                                <a href="{{route('delegates.mainView')}}" class="btn btn-outline-white rounded-pill btn-sm ml-1" role="button">exit <i class="fas fa-arrow-left ml-1"></i></a>
                                @endif
                            </div>
                        </div>
                    </div>
