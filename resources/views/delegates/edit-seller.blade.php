...
<main>
    ...
    <div class="container mt-n5">
        <div class="card">
            ...
            @endif
            <form action="{{ route('delegates.updateSeller', $seller) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row gx-4 mb-4">
                    <!-- Country dropdown -->
                    <div class="col-md-6">
                        <label class="small mb-2" for="country_id">Country <span style="color: red;">*</span></label>
                    ...
                    <!-- City dropdown -->
                    <div class="col-md-6">
                        <label class="small mb-2" for="city_id">City <span style="color: red;">*</span></label>
                ...
                <div class="row gx-4 mb-4">
                    ...
                    <div class="col-md-6">
                        @php
                        $workingHours = $seller->store->work_hours ?? '';
                ...
                <div class="mb-3">
                    ...
                    <div>
                        ...
                        <a href="{{ route('delegates.qr-pdf', ['id' => $seller->store->id]) }}" target="_blank">
                            <img src="{{ $seller->store->sector_qr }}" alt="QR Code" class="img-thumbnail image"  style="max-height: 200px;">
                        </a>
                        @else
